                                        ...
                                        <?php while ($row = $result->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    switch ($status) {
                                                        case 'terseleksi':
                                                            $labelClass = 'label-primary'; // green
                                                            break;
                                                        case 'pending':
                                                            $labelClass = 'label-success'; // blue
                                                            break;
                                                        case 'ditolak':
                                                ...
                                                <td>
                                                <form action="aksi_hapusproduct.php" method="post" style="display:inline;">
                                                        <input type="hidden" name="id_produk" value="<?php echo $row['id_produk']; ?>">
                                                        <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this product?')">Hapus</button>
                                                    </form>
                                                </td>
